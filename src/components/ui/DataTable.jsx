    ...
    <Card className="flex flex-col h-full overflow-hidden">
      ...
      <div className="p-4 border-t border-[#E5E7EB] flex items-center justify-between text-sm">
        ...
        <div className="flex items-center space-x-1">
          ...
          <button className="px-3 py-1 rounded bg-[#04376C] text-white font-medium">
            1
          </button>
          <button className="px-3 py-1 rounded hover:bg-gray-100 text-gray-600 font-medium">
            2
          </button>
          <button className="px-3 py-1 rounded hover:bg-gray-100 text-gray-600 font-medium">
            3
...
export const Th = ({ children, className }) => (
  <th
    className={cn(
      "px-6 py-4 font-semibold text-gray-600 bg-gray-50 border-b border-[#E5E7EB] uppercase tracking-wider text-xs sticky top-0 z-10",
      className,
    )}
  >
    {children}
...
export const Td = ({ children, className }) => (
  <td
    className={cn(
      "px-6 py-4 text-gray-900 border-b border-[#E5E7EB]",
      className,
    )}
  >
    {children}
